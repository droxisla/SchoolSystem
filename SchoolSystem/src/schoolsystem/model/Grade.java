...
public enum Grade {
	...
	NO_GRADE("0", false), G1_00("1.00", true), G1_25("1.25", true), G1_50("1.50", true), G1_75("1.75", true), G2_00(
			"2.00", true), G2_25("2.25", true), G2_50("2.50", true), G2_75("2.75", true), G3_00("3.00", true), G5_00(
			"5.00", false);
	...
	public String toString() {
		return "Grade=" + value.toPlainString();
	}
}
